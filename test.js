var paragraphData = [
  {
    ...
    content:
      "Read Part 2 (pp. 12�21) RI.6.1, RI.6.2, RI.6.3, W.6.2c, W.6.8, W.6.10, SL.6.1a, SL.6.1b, SL.6.1c, SL.6.1d, SL.6.2\r",
    parentPageName: "4",
    characterStyles: [
  ...
  },
  {
    ...
    content:
      "Say: As you read Part 2 (pp. 12�21), use self-stick notes to flag important details about the main idea and key details about Anna Eisenmenger�s experiences supporting and caring for her family. Compare and contrast the experiences of Eisenmenger and Allan, and discuss how the war affected people in all situations and in different places around the world.\r",
    parentPageName: "4",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Invite students to share with a partner what they noted in the text. Have them collaborate to create a new Main Idea and Key Details Chart for Part 2 that lists the most important details of Part 2.\r",
    parentPageName: "4",
    characterStyles: [
      { character: "I", style: "[None]" },
      { character: "n", style: "[None]" },
  ...
  },
  {
    ...
    content: "Sample Part 2 Main Idea and Key Details Chart\r",
    parentPageName: "4",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Bring students together and ask several pairs of students to read their summaries aloud. As a whole group, evaluate the summaries and identify any key details that were omitted. \nAs a group, construct a written summary of the key ideas in Part 2.\r",
    parentPageName: "4",
    characterStyles: [
      { character: "B", style: "[None]" },
      { character: "r", style: "[None]" },
  ...
  },
  {
    ...
    content:
      "During World War I, Anna Eisenmenger and her family experienced many hardships.",
    parentPageName: "4",
    characterStyles: [
  ...
  },
  {
    styleName: "Lesson_Table-body-txt",
    content:
      "In Austria in 1918, the food situation was difficult, and people used ration cards to get food from the government. Eisenmenger hoarded food so her family would have enough to eat.",
    parentPageName: "4",
    characterStyles: [
      { character: "I", style: "Character Style 1" },
      { character: "n", style: "Character Style 1" },
  ...
  },
  {
    styleName: "Lesson_Table-body-txt",
    content:
      "Her family members needed medical attention, especially her son-in-law who was blinded in battle and experienced trauma. Other relatives were weak from hunger and malnutrition.",
    parentPageName: "4",
    characterStyles: [
      { character: "H", style: "Character Style 1" },
      { character: "e", style: "Character Style 1" },
  ...
  },
  {
    styleName: "Lesson_Table-body-txt",
    content:
      "Food situations became so bad that people could barely survive. After the war, poverty increased, and people�s lives hardly improved.",
    parentPageName: "4",
    characterStyles: [
      { character: "F", style: "Character Style 1" },
      { character: "o", style: "Character Style 1" },
  ...
  },
  {
    styleName: "Lesson_Table-body-txt",
    content:
      "The diary entries of Anna Eisenmenger describe the desperate situations people faced at home while the war was fought on the frontlines. Families were starving and surviving on meager food rations. Eisenmenger�s son-in-law and son were difficult to care for after her husband died. Even after the war was over, the Eisenmenger family was left in extreme poverty, and Anna was forced to find other sources of income.",
    parentPageName: "4",
    characterStyles: [
      { character: "T", style: "Character Style 1" },
      { character: "h", style: "Character Style 1" },
...
function parseParagraphData(paragraphData) {
  const styleToTagMapping = {
    "Lesson_B-hd": "h3",
    "Lesson_A-hd": "h2", // Add Lesson_A-hd to styleToTagMapping
    "Lesson_Body-txt": "p",
  ...
  function wrapStandardsText(content) {
    const standardsPattern =
      /(?:RI|W|SL)\.\d+\.\d+[a-zA-Z]*(?:,?\s*(?:RI|W|SL)\.\d+\.\d+[a-zA-Z]*)*/g;
    const standardsMatch = content.match(standardsPattern);

    if (standardsMatch) {
      const standardsText = standardsMatch.join(", ");
      const remainingText = content
        .replace(standardsPattern, "")
        .replace(/\s*,\s*$/, "");
      return `${remainingText} <br><span class="standards">${standardsText}</span>`;
    }
  ...
  const filteredData = paragraphData
    .map((paragraph) => {
      ...
      if (tagName) {
        ...
        content = wrapStandardsText(content); // Wrap standards text
