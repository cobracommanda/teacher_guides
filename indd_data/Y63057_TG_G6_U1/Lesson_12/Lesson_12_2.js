const paragraphData = [bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
  {
    styleName: "Lesson_A-hd",
    content: "Reading, Writing, Speaking, and Listening RI.6.1, RI.6.2, RI.6.4, RI.6.6, W.6.1, W.6.2, W.6.3, W.6.4, W.6.5, W.6.6, W.6.7, W.6.8, W.6.9, RST.6.7, RST.6.8\r",
    parentPageName: "12",
    characterStyles: [
  ...
  },
  {
    ...
    content: "Have students work independently or with a partner to answer questions that require them to find evidence in the text using the Text Evidence Question Card for \nthis book.\r",
    parentPageName: "12",
    characterStyles: [
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Use one of the text-dependent writing prompts below, or create one of your own, to give students the opportunity to demonstrate their understanding of the concepts covered in the text. Rubrics to help you evaluate students’ writing are available in the Digital Teacher’s Guide (BenchmarkUniverse.com).\r",
    parentPageName: "12",
    characterStyles: [
      { character: "U", style: "[None]" },
      { character: "s", style: "[None]" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Informative/explanatory prompt. Write an essay comparing and contrasting two or more biomes. Use compare and contrast signal words in your essay.\r",
    parentPageName: "12",
    characterStyles: [
      { character: "I", style: "b" },
      { character: "n", style: "b" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Have students collaborate to complete the research project outlined on the inside back cover of the text. Use the research project as a context in which to support students’ online research skills and to strengthen students’ presentation skills by requiring them to present their findings formally.\r",
    parentPageName: "12",
    characterStyles: [
      { character: "H", style: "[None]" },
      { character: "a", style: "[None]" },
