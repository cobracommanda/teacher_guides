const paragraphData = [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Reread the second paragraph on page 7. Highlight the term climate.\r",
    parentPageName: "8",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Tchr-tlk",
    content:
      "Say: The author provides a direct definition of climate: “average weather pattern of an area over a long period of time.” I can confirm the definition of climate in the glossary.\r",
    parentPageName: "8",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Have students turn to page 8.Display and highlight the term precipitation.\r",
    parentPageName: "8",
    characterStyles: [
      { character: "H", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Tchr-tlk",
    content:
      "Collaborative conversation (turn and talk). Say: Turn to a partner. Reread the last paragraph and identify evidence from the text that help you define the term precipitation. Write down a definition of precipitation to share with the class.\r",
    parentPageName: "8",
    characterStyles: [
      { character: "C", style: "b" },
      { character: "o", style: "b" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Bring students together and ask several pairs to read aloud their definition. Check the glossary to confirm the definition.\r",
    parentPageName: "8",
    characterStyles: [
      { character: "B", style: "[None]" },
      { character: "r", style: "[None]" },
