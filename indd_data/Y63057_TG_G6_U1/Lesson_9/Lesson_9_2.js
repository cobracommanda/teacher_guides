const paragraphData = [teacher-talkteacher-talkteacher-talkteacher-talk
  {
    ...
    content: "Close Reading Option 3: Identify an Author’s Claim and Supporting Evidence RI.6.8, RST.6-6.1\r",
    parentPageName: "9",
    characterStyles: [
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Explain that the question asks the reader to find evidence in the text that supports the author’s claim.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "E", style: "[None]" },
      { character: "x", style: "[None]" },
  ...
  },
  {
    ...
    content: "Say: I’m going to show you how I read closely to evaluate an author’s argument or claim. To evaluate the validity of an author’s claim, I need to identify evidence in the text that supports it.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Reread page 13 while students follow along.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Display a blank graphic organizer like the one in the margin. Write the argument or claim in the left column, and then ask students to recall evidence in the text that directly supports the argument.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "D", style: "[None]" },
      { character: "i", style: "[None]" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Read aloud the section “Tundra” on page 17 as students follow along. Display a blank graphic organizer like the sample in the margin.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  {
    styleName: "Lesson_Tchr-tlk",
    content: "Collaborative conversation (turn and talk). Say: Think about the author’s claim that animals and plants of the tundra are adapted to the long winters and harsh wind. Find evidence in the text to support that argument. Talk to your partner, and complete a graphic organizer.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "C", style: "b" },
      { character: "o", style: "b" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Ask students to reread page 34. Have them find evidence to support the author’s claim that global warming affects all of the planet’s biomes.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "A", style: "[None]" },
      { character: "s", style: "[None]" },
  ...
  {
    styleName: "Lesson_Tchr-tlk",
    content: "Ask: How did supporting the author’s claim with evidence from the text help your understanding of the concepts?",
    parentPageName: "9",
    characterStyles: [
      { character: "A", style: "[None]" },
      { character: "s", style: "[None]" },
  ...
  },
  {
    ...
    content: "What evidence supports the author’s claim that areas that get their winds and weather from the ocean tend to have a mild climate?",
    parentPageName: "9",
    characterStyles: [
