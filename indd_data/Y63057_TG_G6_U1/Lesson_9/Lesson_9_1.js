const paragraphData = [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Read aloud the section “Tundra” on page 17 as students follow along. Display a blank graphic organizer like the sample in the margin.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Tchr-tlk",
    content:
      "Collaborative conversation (turn and talk). Say: Think about the author’s claim that animals and plants of the tundra are adapted to the long winters and harsh wind. Find evidence in the text to support that argument. Talk to your partner, and complete a graphic organizer.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "C", style: "b" },
      { character: "o", style: "b" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Ask students to reread page 34. Have them find evidence to support the author’s claim that global warming affects all of the planet’s biomes.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "A", style: "[None]" },
      { character: "s", style: "[None]" },
