const paragraphData = [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Read aloud the supporting question on page 30: How can people preserve biomes for the future?\r",
    parentPageName: "6",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    ...
    content:
      "Say: As you read this chapter, continue using the Q-Notes strategy to focus on how people can preserve biomes for the future. Then we’ll collaborate to summarize the main ideas and details.\r",
    parentPageName: "6",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Give students a few moments to review their Q-Notes and to write their own two- to three-sentence summary of the key information in this chapter.\r",
    parentPageName: "6",
    characterStyles: [
      { character: "G", style: "[None]" },
      { character: "i", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "As a group, construct a written summary of the key idea in the chapter.\r",
    parentPageName: "6",
    characterStyles: [
      { character: "A", style: "[None]" },
      { character: "s", style: "[None]" },
