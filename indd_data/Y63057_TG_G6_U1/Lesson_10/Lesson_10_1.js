const paragraphData = [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Text Evidence: “…many people choose to recycle metal cans. These people know that recycling reduces the environmental effects of mining and the energy needed to make new metal products.”  (p. 36) RI.7.1, RI.8.1\r",
    parentPageName: "10",
    characterStyles: [
      { character: "T", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Text Evidence: “People plan before they cut down trees, clear forests, and hunt animals.” (p. 32) RI.7.2, RI.8.2\r",
    parentPageName: "10",
    characterStyles: [
      { character: "T", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Definition: an increase in a planet’s temperature caused by gases in the atmosphere trapping heat on the planet’s surface\r",
    parentPageName: "10",
    characterStyles: [
      { character: "D", style: "[None]" },
      { character: "e", style: "[None]" },
