const paragraphData = [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Read aloud the supporting question on page 16: What are the characteristics of each land biome?\r",
    parentPageName: "5",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    ...
    content:
      "Say: As you read this chapter, continue using Q-Notes to focus on the characteristics of each land biome. Then we’ll collaborate to summarize the main ideas and details.\r",
    parentPageName: "5",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
