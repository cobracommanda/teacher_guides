const paragraphData = [teacher-talkteacher-talk
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Read aloud the supporting question on page 16: What are the characteristics of each land biome?\r",
    parentPageName: "5",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    ...
    content: "Say: As you read this chapter, continue using Q-Notes to focus on the characteristics of each land biome. Then we’ll collaborate to summarize the main ideas and details.\r",
    parentPageName: "5",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Invite students to share their Q-Notes with a partner and agree on the key ideas in the chapter. Explain that partners should collaborate to write their own two- to three-sentence summaries of the key information in the chapter.\r",
    parentPageName: "5",
    characterStyles: [
      { character: "I", style: "[None]" },
      { character: "n", style: "[None]" },
  ...
  {
    styleName: "Lesson_Tchr-tlk",
    content: "Say: Remember, a summary is a short statement of the most important information \nin a text.\r",
    parentPageName: "5",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Bring students together and ask several pairs of students to share their summaries. As a whole group, evaluate the summaries and identify any key information that was omitted. As needed, clarify students’ understanding of the supporting question.\r",
    parentPageName: "5",
    characterStyles: [
      { character: "B", style: "[None]" },
      { character: "r", style: "[None]" },
