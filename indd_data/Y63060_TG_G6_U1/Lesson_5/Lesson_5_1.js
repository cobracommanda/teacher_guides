const paragraphData = [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Read aloud the supporting question on page 24: What are the characteristics of freshwater biomes?\r",
    parentPageName: "5",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    ...
    content:
      "Say: As you read this chapter, continue using Q-Notes to focus on the characteristics of freshwater biomes. Then we’ll collaborate to summarize the main ideas and details.\r",
    parentPageName: "5",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Invite students to share their Q-Notes with a partner and agree on the key ideas in the chapter. Explain that partners should collaborate to write their own two- to three-sentence summaries of the key information in the chapter.\r",
    parentPageName: "5",
    characterStyles: [
      { character: "I", style: "[None]" },
      { character: "n", style: "[None]" },
