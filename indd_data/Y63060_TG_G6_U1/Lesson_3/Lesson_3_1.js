const paragraphData = [
  {
    ...
    content: "Read Chapter 1RI.6.2, RST.6.2, SL.6.1\r",
    parentPageName: "3",
    characterStyles: [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Read aloud the supporting question on page 6: What are the characteristics of each marine biome?\r",
    parentPageName: "3",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    ...
    content:
      "Say: As you read this chapter, you will use a strategy called Q-Notes to help you understand the characteristics of each marine biome.\r",
    parentPageName: "3",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
  ...
  {
    styleName: "Lesson_Body-txt",
    content: "Read aloud page 9 and model how you use the Q-Notes format.\r",
    parentPageName: "3",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Invite students to share their Q-Notes. What questions did they ask in the left column? Do the answers they recorded in the right column provide information needed to understand central ideas and concepts? Provide time for students to share and discuss their notes with the class.\r",
    parentPageName: "3",
    characterStyles: [
      { character: "I", style: "[None]" },
      { character: "n", style: "[None]" },
