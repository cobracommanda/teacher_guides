const paragraphData = [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Read aloud the supporting question on page 34: How can people save aquatic biomes for the future?\r",
    parentPageName: "6",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    ...
    content:
      "Say: As you read this chapter, continue using the Q-Notes strategy to focus on how people can save aquatic biomes for the future. Then we’ll collaborate to summarize the main ideas and details.\r",
    parentPageName: "6",
    characterStyles: [
      { character: "S", style: "[None]" },
      { character: "a", style: "[None]" },
