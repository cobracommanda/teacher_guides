const paragraphData = [
  {
    ...
    content:
      "Close Reading Option 3: Use Text Evidence to Draw Inferences RI.6.1, RST.6.1\r",
    parentPageName: "9",
    characterStyles: [
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Reread the second paragraph on page 8 while students follow along.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Display a blank graphic organizer like the one in the margin. Write in the inference; then ask students to recall supporting evidence from the text.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "D", style: "[None]" },
      { character: "i", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Read aloud the second paragraph on page 10 as students follow along. Display a blank graphic organizer like the sample in the margin.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "R", style: "[None]" },
      { character: "e", style: "[None]" },
  ...
  },
  {
    styleName: "Lesson_Tchr-tlk",
    content:
      "Collaborative conversation (turn and talk). Say: Think about what you read about communities and populations. Using evidence from the text, make an inference about the number of populations that can exist in a community. Talk to your partner, and complete a graphic organizer.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "C", style: "b" },
      { character: "o", style: "b" },
  ...
  },
  {
    styleName: "Lesson_Body-txt",
    content:
      "Ask students to reread page 27. Have them use evidence from the text to draw and support an inference about the requirements of living things.\r",
    parentPageName: "9",
    characterStyles: [
      { character: "A", style: "[None]" },
      { character: "s", style: "[None]" },
